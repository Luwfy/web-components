...
*/
LW('lw-switch-button', class SwitchButton extends LW.ToggleButton {
    ...
    */
    ...
    template() {
        return `<div  id='container' class='lw-container' role="presentation">
                    <div id='innerContainer' class='lw-inner-container' role="presentation">
                        <span id='falseContentContainer' inner-h-t-m-l='[[falseContent]]' class='lw-false-content-container'></span>
                        <span id='switchThumb' class='lw-thumb' role="presentation"></span>
                        <span id='trueContentContainer' inner-h-t-m-l='[[trueContent]]' class='lw-true-content-container'></span>
                    </div>
    ...
    ready() {
        ...
        that._supportCSSVariables = LW.Utilities.Core.CSSVariablesSupport() && Boolean(window.getComputedStyle(that.$.container).getPropertyValue('--lw-switch-button-default-width'));
    ...
    _mouseDownHandler(event) {
        ...
        if (event.originalEvent.target.closest('.lw-thumb') === that.$.switchThumb && (that.switchMode === 'default' || that.switchMode === 'drag')) {
    ...
    */
    ...
    _resizeHandler() {
        ...
        if (that._supportCSSVariables) {
            that.$.container.style.setProperty('--lw-switch-button-default-width', newWidth + 'px');
        }
        else {
