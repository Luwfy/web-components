...
*/
LW('lw-drop-down-button', class DropDownButton extends LW.ContentElement {
    /**
    ...
    static get properties() {
        return {
            ...
            'messages': {
                ...
                value: {
                    'en': {
                        'invalidNode': 'lw-drop-down-button: Invalid parameter "{{node}}" when calling {{method}}.'
                    }
                },
                type: 'object'
            },
        ...
        return `<div id="container" role="presentation">
                    ...
                    <div id="content" class="lw-content" role="presentation">
                        <div id="buttonsContainer" class="lw-buttons-container" role="presentation">
                            <span id="actionButton" class="lw-action-button">[[placeholder]]</span>
                            <span id="dropDownButton" class="lw-drop-down-button">
                                <span class="lw-drop-down-button-icon" id="arrow" aria-hidden="true"></span>
                            </span>
                        </div>
                        <div id="dropDownContainer" class="lw-drop-down lw-drop-down-container lw-visibility-hidden" role="dialog">
                            <lw-scroll-viewer id="scrollViewer"
                    ...
                    <span class="lw-hidden lw-hint" id="hint">[[hint]]</span>
                </div>`;
    }
 ...
 */
    ...
    _documentUpHandler(event) {
        ...
        if ((!that.editable && isActionButtonPressed === that.$.actionButton) || target.closest('.lw-drop-down-button') === that.$.dropDownButton) {
   ...
   */
    ...
    _buttonsDownHandler(event) {
        ...
        if (that.dropDownOpenMode === 'dropDownButton' && event.target === that.$.actionButton &&
            that.tagName.toLowerCase() === 'lw-drop-down-button') {
