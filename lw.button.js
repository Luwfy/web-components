...
*/
LW('lw-button', class Button extends LW.ContentElement {
    // Button's properties.
    ...
    */
    ...
    /** Button's template. */
    template() {
        return '<button class="lw-button lw-unselectable" inner-h-t-m-l=\'[[innerHTML]]\' id=\'button\' type=\'[[type]]\' name=\'[[name]]\' value=\'[[value]]\' disabled=\'[[disabled]]\' role="presentation"></button>';
    }
    ...
    _downHandler(event) {
        ...
        if (that.hasRippleAnimation) {
            LW.Utilities.Animation.Ripple.animate(that, event.pageX, event.pageY);
        }
...
*/
    propertyChangedHandler(propertyName, oldValue, newValue) {
        ...
        if (propertyName === 'disabled') {
            ...
            if (that instanceof LW.RepeatButton) {
                that._stopRepeat();
            }
        }
...
* Repeat Button.
*/
LW('lw-repeat-button', class RepeatButton extends LW.Button {
    // button's properties.
    static get properties() {
        return {
            'delay': {
...
* Toggle Button.
*/
LW('lw-toggle-button', class ToggleButton extends LW.Button {
    ...
    */
    ...
    _handleTextSelection() {
        ...
        that.timer = setTimeout(() => that.$.removeClass('lw-unselectable'), 500);
    }
    ...
    */
    ...
    _htmlBindOnInitialization() {
        ...
        that._bindContentProperty('trueContent', 'lw-true-content');
        that._bindContentProperty('falseContent', 'lw-false-content');
        that._bindContentProperty('indeterminateContent', 'lw-indeterminate-content');
    }
